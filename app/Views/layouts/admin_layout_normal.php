<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed layout-menu-100vh" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo _WEB.'/public/assets/sneat/'?>" data-template="vertical-menu-template-free">
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            <?php
            $this->renderView('blocks/admin_menu'); ?>
            <!-- Layout container -->
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        $this->renderView('blocks/admin_footer'); ?>
                    </div>
                </div>
                <?php
    ...
    <!-- Page JS -->
    <script src="<?php echo _WEB . "/public/assets/sneat/js/dashboards-analytics.js" ?>"></script>
